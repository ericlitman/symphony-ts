 ...
 * Converted from token-report.mjs:1801–1819.
 *
 * Props:
 *   - perProduct: object keyed by product name → { total_tokens, total_stages, unique_issues }
 */
...
export default function PerProductBreakdown({ perProduct }) {
